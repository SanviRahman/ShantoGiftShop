...
<body>
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="{{ route('admin.subscribes.index') }}"
                    class="{{ request()->routeIs('admin.subscribes.*') ? 'active' : '' }}">
    ...
    <div class="main-content">
        ...
        <main class="content">
            @if(session('success'))
            <div
                style="background: #d4edda; color: #155724; padding: 15px; border-radius: 4px; margin-bottom: 20px; border: 1px solid #c3e6cb;">
                {{ session('success') }}
            </div>
            @endif
